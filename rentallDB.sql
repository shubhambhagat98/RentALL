...
CREATE TABLE `message` (
  ...
  `to_user_name` varchar(45) NOT NULL,
...
CREATE TABLE `product` (
  ...
  `prod_title` varchar(45) NOT NULL,
  `prod_description` varchar(1000) NOT NULL,
  `prod_category` varchar(45) NOT NULL,
  `prod_price` int NOT NULL,
  `prod_duration` varchar(45) NOT NULL,
  `prod_street_address` varchar(100) NOT NULL,
  `prod_city` varchar(45) NOT NULL,
  `prod_state` varchar(45) NOT NULL,
  `prod_pincode` int NOT NULL,
  `prod_status` varchar(45) NOT NULL DEFAULT 'not approved',
...
INSERT INTO `product_category` VALUES (1,'car'),(2,'bike'),(3,'two wheeler'),(4,'boat'),(5,'apartment'),(6,'services'),(7,'party hall'),(8,'others');
...
CREATE TABLE `review` (
  ...
  `review_title` varchar(90) NOT NULL,
  `review_description` varchar(755) NOT NULL,
  `review_date` varchar(10) NOT NULL,
  `review_rating` int NOT NULL,
  `reviewer_name` varchar(45) NOT NULL,
  `prod_id` int NOT NULL,
  PRIMARY KEY (`review_id`),
  KEY `r_user_id_idx` (`reviewer_name`)
...
CREATE TABLE `user` (
  ...
  `security_1` varchar(45) DEFAULT NULL,
  `security_2` varchar(45) DEFAULT NULL,
  `security_3` varchar(45) DEFAULT NULL,
...
CREATE TABLE `wishlist` (
  ...
  CONSTRAINT `wishlist_prod_id` FOREIGN KEY (`prod_id`) REFERENCES `product` (`prod_id`),
  CONSTRAINT `wishlist_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-01-15 19:49:53
